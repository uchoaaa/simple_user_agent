...
describe 'UserAgentParser to Computers user_agents strings' do
  ...
  it 'should be Mac OS and Safari' do
    ...
    should_be 'Computer', 'Mac OS', 'Safari'
  end
  ...
  it 'should be Mac OS and Chrome' do
    ...
    should_be 'Computer', 'Mac OS', 'Chrome'
  end 

  it 'should be Mac OS and Firefox' do
    user_agent 'Mozilla/5.0 (Macintosh; Intel Mac OS X x.y; rv:10.0) Gecko/20100101 Firefox/10.0'
    should_be 'Computer', 'Mac OS', 'Firefox'
  ...
  it 'should be Mac OS and Other' do
    ...
    should_be 'Computer', 'Mac OS', 'Other'
  ...
  it 'should be Windows and Chrome' do
    ...
    should_be 'Computer', 'Windows', 'Chrome'
  end 
  ...
  it 'should be Windows and IE' do
    ...
    should_be 'Computer', 'Windows', 'Internet Explorer'
  ...
  it 'should be Windows and Other' do
    ...
    should_be 'Computer', 'Windows', 'Other'
  ...
  it 'should be Linux and Firefox' do
    ...
    should_be 'Computer', 'Linux', 'Firefox'
